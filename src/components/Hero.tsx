      ...
      <div className="relative h-screen flex items-center">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24 md:py-32">
          <div className="max-w-5xl mx-auto text-center">
            <h1 className="text-3xl md:text-4xl lg:text-5xl font-bold text-white mb-16 leading-tight tracking-wide">
              {t('hero.welcome')}
            </h1>
            <div className="text-lg md:text-xl lg:text-2xl text-white opacity-90 leading-relaxed">
